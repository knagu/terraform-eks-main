...
resource "aws_internet_gateway" "this" {
  ...
  tags = merge(
    {
      "Name" = format("%s", "${var.prefix}-${var.project}-${var.env}-igw")
    },
    var.tags,
    var.igw_tags,
  )
...
resource "aws_route_table" "public" {
  ...
  tags = merge(
    {
      "Name" = format("%s-${var.public_subnet_suffix}", "${var.prefix}-${var.project}-${var.env}-rttable")
    },
    var.tags,
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway ? "${var.name}-${var.private_subnet_suffix}" : format(
        ...
        "${var.prefix}-${var.project}-${var.env}-rttable",
  ...
  tags = merge(
    {
      "Name" = format(
        ...
        "${var.prefix}-${var.project}-${var.env}-subnet",
        element(var.azs, count.index),
      )
    },
    var.tags,
...
resource "aws_network_acl" "public" {
  ...
  tags = merge(
    {
      "Name" = format("%s-${var.public_subnet_suffix}", "${var.prefix}-${var.project}-${var.env}-nacl")
    },
    var.tags,
    var.public_acl_tags,
  )
...
resource "aws_network_acl" "private" {
  ...
  tags = merge(
    {
      "Name" = format("%s-${var.private_subnet_suffix}", "${var.prefix}-${var.project}-${var.env}-nacl")
    },
    var.tags,
...
resource "aws_network_acl" "database" {
  ...
  tags = merge(
    {
      "Name" = format("%s-${var.database_subnet_suffix}", "${var.prefix}-${var.project}-${var.env}-nacl")
    },
    var.tags,
  ...
  tags = merge(
    {
      "Name" = format(
        "%s-%s",
        "${var.prefix}-${var.project}-${var.env}-eip",
  ...
  tags = merge(
    {
      "Name" = format(
        "%s-%s",
        "${var.prefix}-${var.project}-${var.env}-natgw",
        element(var.azs, var.single_nat_gateway ? 0 : count.index),
      )
    },
    var.tags,
